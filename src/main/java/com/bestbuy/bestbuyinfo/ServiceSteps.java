...
public class ServiceSteps
{
    ...
    public ValidatableResponse getAllServiceInformation (){
        return SerenityRest
                .given()
                .when()
                .get(Path.SERVICES)
    ...
    @Step("Getting the service information with name")
    public HashMap<String, Object> getServiceInfoByName(String name,int id)
    {
    ...
    public ValidatableResponse updateService( int id, String name)
    {
        ...
        return SerenityRest.given().log().all()
                ...
                .body(servicePojo)
                .when()
                .put(Path.SERVICES+EndPoints.UPDATE_SERVICE_BY_ID)
                .then();
    }
    ...
    public ValidatableResponse deleteService(int id){
        return SerenityRest
                ...
                .pathParam("id", id)
                .when()
                .delete(Path.SERVICES+EndPoints.DELETE_SERVICE_BY_ID)
                .then();
    }
    ...
    public ValidatableResponse getServiceById (int id){
        return SerenityRest
                ...
                .pathParam("id", id)
                .when()
                .get(Path.SERVICES+EndPoints.GET_SERVICE_PRODUCT_BY_ID)
                .then();
    }
